...
<template>
	<div
		...
		:class="[
			'static flex flex-col flex-grow  bg-[#4374a1] overflow-y-auto custom-scrollbar border-r-2 border-secondary border-dotted  transition-all ease-in-out duration-300 group/sidebar h-full ',
			!isSidebarOpen
